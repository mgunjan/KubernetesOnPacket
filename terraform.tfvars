...
master_hostname="demo-k8s-master"
worker_hostname="demo-k8s-worker"
...
# Available list of plans: baremetal_0, baremetal_1,baremetal_1e,baremetal_2,baremetal_2a,baremetal_3,baremetal_s,c2.medium.x86,m2.xlarge.x86,storage_1,storage_2
# Find below, references to  most used plans for Sprint

# master_server_type="baremetal_2" # large x86 server with 10G Mellanox card
# worker_server_type="baremetal_2" # large x86 server with 10G Mellanox card
# master_server_type="baremetal_2a" # large arm server with 10G Mellanox cards
# worker_server_type="baremetal_2a" # large arm server with 10G Mellanox cards
...
master_tags=["kubemaster","managedbytf","kubecluster"]  
worker_tags=["kubeworker","managedbytf","kubecluster"]  
